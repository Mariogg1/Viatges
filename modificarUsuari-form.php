...
<?php
    ...
    echo "<FORM METHOD='POST' ACTION='javascript:void(0)' onsubmit='modificarUsuari(this.elements.id.value, this.elements.nomUsuari.value, this.elements.contrasenya.value, this.elements.nom.value, this.elements.primerCognom.value, this.elements.segonCognom.value, this.elements.correuElectronic.value)'><br>";
    ...
    <input type='submit' class='btn btn-primary' value="Actualitza"></button>
    </FORM>
